...
# 停用词路径
# stop_word_path = os.path.join(root, 'data', '哈工大停用词表.txt')
stop_word_path = 'data/哈工大停用词.txt'
...
train_seg_path = 'data/train_seg_data.csv'
# 预处理后的测试数据
# test_seg_path = os.path.join(root, 'data', 'test_seg_data.csv')
test_seg_path = 'data/test_seg_data.csv'
# 合并训练集测试集数据
# merger_seg_path = os.path.join(root, 'data', 'merged_train_test_seg_data.csv')
merger_seg_path = 'data/merged_train_test_seg_data.csv'
# 1. 数据标签分离
...
train_x_seg_path = 'data/train_X_seg_data.csv'
train_y_seg_path = 'data/train_Y_seg_data.csv'
test_x_seg_path = 'data/test_X_seg_data.csv'
# 2. pad oov处理后的数据
...
save_wv_model_path = 'data/wv/word2vec.model'
